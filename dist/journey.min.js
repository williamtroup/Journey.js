...
1};this.getVersion=function(){return"0.2.0"};(function(a,c){p=a;r=c;Q();p.addEventListener("DOMContentLoaded",function(){I=t("div","journey-js-disabled-background");h=t("div","journey-js-dialog");h.style.display="none";p.body.appendChild(h);var b=t("button","close");b.onclick=G;h.appendChild(b);z=t("div","title");h.appendChild(z);A=t("div","description");h.appendChild(A);b=t("div","buttons");h.appendChild(b);w=t("button","previous");w.onclick=R;b.appendChild(w);y=t("button","next");y.onclick=S;b.appendChild(y);
b=f.domElementTypes;for(var d=b.length,g=0;g<d;g++){var u=p.getElementsByTagName(b[g]);u=[].slice.call(u);for(var U=u.length,L=0;L<U;L++){var D=u[L],M=!0;if(l(D)&&D.hasAttribute("data-journey-options")){var e=D.getAttribute("data-journey-options");if(v(e))if(e=T(e),e.parsed&&B(e.result)){e=e.result;var m=e=B(e)?e:{};var E=e.order;E=P(E)?E:0;m.order=E;e.title=x(e.title,null);e.description=x(e.description,null);m=e.onEnter;m=C(m)?m:null;e.onEnter=m;m=e.onLeave;m=C(m)?m:null;e.onLeave=m;e.element=D;
P(e.order)&&(H[e.order]=e,n.push(e.order))}else f.safeMode||(console.error("The attribute 'data-journey-options' is not a valid object."),M=!1);else f.safeMode||(console.error("The attribute 'data-journey-options' has not been set correctly."),M=!1)}if(!M)break}}n.sort()});l(r.$journey)||(r.$journey=this)})(document,window)})();