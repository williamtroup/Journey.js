...
e.nextButtonText;r(a.title)?E.innerHTML=a.title:E.innerHTML=q.empty;r(a.description)?F.innerHTML=a.description:F.innerHTML=q.empty;f.style.display="block";if(a.attach){for(var k=a.element,u=g=0;k&&!isNaN(k.offsetLeft)&&!isNaN(k.offsetTop);)g+=k.offsetLeft-k.scrollLeft,u+=k.offsetTop-k.scrollTop,k=k.offsetParent;b=u-b+a.element.offsetHeight;c=g-c;c+f.offsetWidth>m.innerWidth&&(c-=f.offsetWidth+a.element.offsetWidth);b+f.offsetHeight>m.innerHeight&&(b-=f.offsetHeight+a.element.offsetHeight);f.style.top=
