...
(function(){function v(){var a=z[n[l]];k(a.element)&&G(a.onClose,a.element);H(!1);a=m.body;var c=I;try{a.contains(c)&&a.removeChild(c)}catch(b){console.warn(b.message)}g.style.display="none"}function S(){0<l&&(H(),l--,J())}function T(){l===n.length-1?v():(H(),l++,J())}function J(){var a=z[n[l]];if(k(a)&&k(a.element)){var c=m.body,b=I;try{c.contains(b)||c.appendChild(b)}catch(u){console.warn(u.message)}A.style.display=f.showCloseButton?"block":"none";a.element.className+=p.space+"journey-js-element-focus";
