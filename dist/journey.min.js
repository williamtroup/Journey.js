...
b;a.domElementTypes=c;e.backButtonText=G(e.backButtonText,"Back");e.nextButtonText=G(e.nextButtonText,"Next");e.finishButtonText=G(e.finishButtonText,"Finish");e.showCloseButton=u(e.showCloseButton,!0);e.shortcutKeysEnabled=u(e.shortcutKeysEnabled,!0);e.showProgressDots=u(e.showProgressDots,!0);e.browserUrlParametersEnabled=u(e.browserUrlParametersEnabled,!0)}var N=this,p=null,n=null,e={},F={escape:27,left:37,up:38,right:39,down:40},r={empty:"",space:" "},T={},B={},m=[],k=0,R=null,Q=null,h=null,J=
null,L=null,M=null,E=null,D=null,K=null;this.setConfiguration=function(a){e=O(a)?a:{};Y();N.isOpen()&&(A(),k=0);return this};this.show=function(){k===m.length-1&&(k=0);w()};this.hide=function(){A()};this.isOpen=function(){return"block"===h.style.display};this.isComplete=function(){return k>=m.length-1};this.getVersion=function(){return"0.7.0"};(function(a,c){p=a;n=c;Y();p.addEventListener("DOMContentLoaded",function(){Q=q("div","journey-js-disabled-background");h=q("div","journey-js-dialog");h.style.display=
"none";p.body.appendChild(h);J=q("button","close");J.onclick=A;h.appendChild(J);L=q("div","title");h.appendChild(L);M=q("div","description");h.appendChild(M);E=q("div","progress-dots");h.appendChild(E);var b=q("div","buttons");h.appendChild(b);D=q("button","back");D.onclick=V;b.appendChild(D);K=q("button","next");K.onclick=W;b.appendChild(K);b=e.domElementTypes;for(var f=b.length,g=0;g<f;g++){var t=p.getElementsByTagName(b[g]);t=[].slice.call(t);for(var x=t.length,z=0;z<x;z++){var I=t[z],U=!0;if(l(I)&&
I.hasAttribute("data-journey-options")){var d=I.getAttribute("data-journey-options");if(v(d))if(d=ca(d),d.parsed&&O(d.result)){d=d.result;var da=d=O(d)?d:{};var P=d.order;P=X(P)?P:0;da.order=P;d.attach=u(d.attach,!0);d.sendClick=u(d.sendClick,!1);d.alignTop=u(d.alignTop,!1);d.alignRight=u(d.alignRight,!1);d.title=G(d.title,null);d.description=G(d.description,null);d.onEnter=H(d.onEnter,null);d.onLeave=H(d.onLeave,null);d.onClose=H(d.onClose,null);d.onFinish=H(d.onFinish,null);d.onOpen=H(d.onOpen,
